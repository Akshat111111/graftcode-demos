...
- **.NET / C#** → `graftcode-dotnet.md` (trigger: glob on `**/*.cs`)
- **TypeScript / Node / Next.js** → `graftcode-typescript-node-nextjs.md` (trigger: glob on `**/*.ts`, `**/*.tsx`, `**/*.js`, `**/*.jsx`, `**/*.mjs`, `**/*.cjs`)
- **Java** → `graftcode-java.md` (trigger: glob on `**/*.java`)
- **Kotlin** → `graftcode-kotlin.md` (trigger: glob on `**/*.kt`, `**/*.kts`)
- **Python** → `graftcode-python.md` (trigger: glob on `**/*.py`)
- **PHP** → `graftcode-php.md` (trigger: glob on `**/*.php`)
- **Ruby** → `graftcode-ruby.md` (trigger: glob on `**/*.rb`)
