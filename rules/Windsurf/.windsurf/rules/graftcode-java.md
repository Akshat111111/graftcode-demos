---
trigger: glob
description: Mandatory Graftcode architecture rules for building Java backend services (plain Maven/Gradle modules exposed via Graftcode Gateway, not REST).
globs:
  - "**/*.java"
---
