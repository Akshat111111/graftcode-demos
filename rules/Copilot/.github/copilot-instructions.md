...
- **.NET / C#** → `.github/instructions/graftcode-dotnet.instructions.md` (applies to `**/*.cs`)
- **TypeScript / Node / Next.js** → `.github/instructions/graftcode-typescript-node-nextjs.instructions.md` (applies to `**/*.ts`, `**/*.tsx`, `**/*.js`, `**/*.jsx`, `**/*.mjs`, `**/*.cjs`)
- **Java** → `.github/instructions/graftcode-java.instructions.md` (applies to `**/*.java`)
- **Kotlin** → `.github/instructions/graftcode-kotlin.instructions.md` (applies to `**/*.kt`, `**/*.kts`)
- **Python** → `.github/instructions/graftcode-python.instructions.md` (applies to `**/*.py`)
- **PHP** → `.github/instructions/graftcode-php.instructions.md` (applies to `**/*.php`)
- **Ruby** → `.github/instructions/graftcode-ruby.instructions.md` (applies to `**/*.rb`)
